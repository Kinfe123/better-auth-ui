              ...
              <div className="">
                <div className="container mx-auto grid h-full md:flex items-start gap-14 max-w-7xl">
                  ...
                  <div className="relative max-w-[35%] mx-auto pt-20 px-10">
                    <div className="absolute h-screen ml-1 mt-1 w-full pointer-events-none inset-0 flex items-center justify-center border-l-[1.1px] bg-transparent/10 border-gray-200/20 dark:bg-transparent"></div>
