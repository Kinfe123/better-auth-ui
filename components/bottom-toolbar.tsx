...
const BottomToolbar: React.FC = () => {
  ...
  return (
    <div className="backdrop-blur-2xl sticky z-20 bg-transparent -bottom-12  left-0 right-0 border-t-2 border-white/10 text-white text-xs flex items-center justify-between px-2 py-1">
